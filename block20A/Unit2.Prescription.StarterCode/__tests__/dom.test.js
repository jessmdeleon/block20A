...
describe("The document", () => {
  ...
  test("displays the correct cost for the user's input values after clicking the calculate button", () => {
    ...
    // Calculate the expected cost based on the input values
    const expectedCost = "$67.50"; // Expected cost based on the provided sample data
  
    // Verify that the displayed cost matches the expected cost
    expect(cost.textContent).toBe(expectedCost);
  });  
});